using System.IO;
using System.Linq;
using MetaFarms.Libs.Generators.Templating.Tests.Utils;
using Microsoft.CodeAnalysis.CSharp;
using Xunit;

namespace MetaFarms.Libs.Templating.Tests;
...
Customer";
    ...
    public void GenerateClassesBasedOnDDDRegistry()
    {
        ...
        var generatedFiles = newCompilation.SyntaxTrees.Select(t => Path.GetFileName(t.FilePath))
            .ToArray();
