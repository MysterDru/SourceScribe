...
namespace SourceScribe.CodeModel.Roslyn
{
    internal class Type : SymbolBase, IType, ITypeReferencedByMember
    {
        ...
        public IType BaseType => Type.CreateBaseType(symbol.BaseType);
        ...
        public IType ArrayType => symbol is IArrayTypeSymbol arraySymbol ? Type.Create(arraySymbol.ElementType) : null;
